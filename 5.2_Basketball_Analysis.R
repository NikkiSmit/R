...
#Source: www.superdatascience.com -Kirill Eremenko
...
#Data required for our matrices
#Seasons
...
#We will again need the Games matrix for plotting questions
...
#              *Each FreeThrow is worth 1 point
...
#Matrix
#Create matrix here from code above
...
#Rename the rows
row.names(FreeThrowAttempts) <- Players
